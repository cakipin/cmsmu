...
import { C as array, D as object, H as createHeadAndContent, K as unescapeHTML, P as safeParseAsync, T as date, Z as escape, _ as renderTemplate, a as renderScriptElement, j as string, l as renderComponent, o as renderUniqueStylesheet } from "./server__3e0ELtE.mjs";
import { c as isRemotePath, d as removeBase, u as prependForwardSlash } from "./path_BqUacSWD.mjs";
import { m as unflatten, p as parse } from "./entrypoints_DCagg2Tt.mjs";
import { J as RenderUndefinedEntryError, n as AstroError, nt as UnknownContentCollectionError } from "./shorthash_DJJwdab3.mjs";
import { t as createComponent } from "./astro-component_D9NtsI1-.mjs";
import { o as $$Layout, r as $$Header, t as $$Footer } from "./Footer_BnjUarGW.mjs";
import { t as config } from "./config_BdbSVu5n.mjs";
import { d as VALID_INPUT_FORMATS } from "./assets_CgXAQWao.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_BGMm6prl.mjs");
...
function createGetCollection({ liveCollections }) {
	return async function getCollection(collection, filter) {
		...
		if (await store.hasCollection(collection)) {
			const { default: imageAssetMap } = await import("./content-assets_BabcVmeS.mjs");
			const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_BKvzkKQp.mjs");
...
async function renderEntry(entry) {
	...
	if (entry.deferredRender) try {
		const { default: contentModules } = await import("./content-modules_DnTXu6y1.mjs");
...
}, "/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/about.astro", void 0);
var $$file = "/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/about.astro";
var $$url = "/about";
//#endregion
