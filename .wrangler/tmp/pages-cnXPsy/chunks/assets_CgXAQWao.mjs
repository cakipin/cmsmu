...
import { F as MissingImageDimension, O as InvalidImageService, S as IncompatibleDescriptorOptions, d as ExpectedImageOptions, f as ExpectedNotESMImage, it as UnsupportedImageFormat, k as LocalImageUsedWrongly, n as AstroError, p as FailedToFetchRemoteImageDimensions, q as RemoteImageNotAllowed, rt as UnsupportedImageConversion, t as shorthash, u as ExpectedImage, z as NoImageMetadata } from "./shorthash_DJJwdab3.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_Y4jDZwMG.mjs").catch((e) => {
...
//#endregion
export { baseService as a, isESMImportedImage as c, VALID_INPUT_FORMATS as d, getImage as i, isRemoteImage as l, propsToFilename as n, inferRemoteSize as o, getConfiguredImageService as r, fetchWithRedirects as s, hashTransform as t, resolveSrc as u };
