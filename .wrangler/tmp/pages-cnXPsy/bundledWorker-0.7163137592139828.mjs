...
// _worker.js/index.js
import { r as __toESM, t as __commonJSMin } from "./chunks/rolldown-runtime_BDykq6kg.mjs";
import { G as createVNode, W as AstroJSX, f as chunkToString, u as renderStreaming } from "./chunks/server__3e0ELtE.mjs";
import { h as slash } from "./chunks/path_BqUacSWD.mjs";
import { a as App, o as DefaultFetchHandler, r as deserializeRouteInfo, t as deserializeManifest } from "./chunks/entrypoints_DCagg2Tt.mjs";
import { r as AstroUserError } from "./chunks/shorthash_DJJwdab3.mjs";
import { t as require_react } from "./chunks/react_DrT0j-Yv.mjs";
...
performance.now();setTimeout(w,2300>q&&2E3<q?2300-q:500)})])},types:[]});z.ready.finally(function(){for(var a=l.length-3;0<=a;a-=3){var b=l[a],e=b.style;e.viewTransitionName=l[a+1];e.viewTransitionClass=l[a+1];""===b.getAttribute("style")&&b.removeAttribute("style")}});z.finished.finally(function(){document.__reactViewTransition===z&&(document.__reactViewTransition=null)});$RB=[];return}}catch(a){}A(g)}.bind(null,$RV);`);
  ...
  function prepareStackTrace(error3, structuredStackTrace) {
    ...
    for (var i = 0; i < structuredStackTrace.length; i++) error3 += "\n    at " + structuredStackTrace[i].toString();
    return error3;
  }
      ...
      var RunInRootFrame = { DetermineComponentFrameRoot: /* @__PURE__ */ __name(function() {
        try {
          if (construct) {
            ...
            Object.defineProperty(Fake.prototype, "props", { set: /* @__PURE__ */ __name(function() {
              throw Error();
            }, "set") });
  ...
  function defaultErrorHandler(error3) {
    if ("object" === typeof error3 && null !== error3 && "string" === typeof error3.environmentName) {
      ...
      "string" === typeof error3[0] ? error3.splice(0, 1, "\x1B[0m\x1B[7m%c%s\x1B[0m%c " + error3[0], "background: #e6e6e6;background: light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.25));color: #000000;color: light-dark(#000000, #ffffff);border-radius: 2px", " " + JSCompiler_inline_result + " ", "") : error3.splice(0, 0, "\x1B[0m\x1B[7m%c%s\x1B[0m%c", "background: #e6e6e6;background: light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.25));color: #000000;color: light-dark(#000000, #ffffff);border-radius: 2px", " " + JSCompiler_inline_result + " ", "");
  ...
  function createRenderTask(request, thenableState2, node, childIndex, blockedBoundary, blockedSegment, blockedPreamble, hoistableState, abortSet, keyPath, formatContext, context2, treeContext, row, componentStack) {
  ...
  function createReplayTask(request, thenableState2, replay, node, childIndex, blockedBoundary, hoistableState, abortSet, keyPath, formatContext, context2, treeContext, row, componentStack) {
    request.allPendingTasks++;
    null === blockedBoundary ? request.pendingRootTasks++ : blockedBoundary.pendingTasks++;
    null !== row && row.pendingTasks++;
    replay.pendingTasks++;
  ...
  function renderElement(request, task, keyPath, type, props, ref2) {
    if ("function" === typeof type) if (type.prototype && type.prototype.isReactComponent) {
      ...
      if ("function" !== typeof type.getDerivedStateFromProps && "function" !== typeof newProps.getSnapshotBeforeUpdate && ("function" === typeof newProps.UNSAFE_componentWillMount || "function" === typeof newProps.componentWillMount)) if (type = newProps.state, "function" === typeof newProps.componentWillMount && newProps.componentWillMount(), "function" === typeof newProps.UNSAFE_componentWillMount && newProps.UNSAFE_componentWillMount(), type !== newProps.state && classComponentUpdater.enqueueReplaceState(newProps, newProps.state, null), null !== defaultProps.queue && 0 < defaultProps.queue.length) if (type = defaultProps.queue, ref2 = defaultProps.replace, defaultProps.queue = null, defaultProps.replace = false, ref2 && 1 === type.length) newProps.state = type[0];
      else {
        defaultProps = ref2 ? type[0] : newProps.state;
        initialState = true;
        for (ref2 = ref2 ? 1 : 0; ref2 < type.length; ref2++) propName$44 = type[ref2], propName$44 = "function" === typeof propName$44 ? propName$44.call(newProps, defaultProps, props, void 0) : propName$44, null != propName$44 && (initialState ? (initialState = false, defaultProps = assign({}, defaultProps, propName$44)) : assign(defaultProps, propName$44));
                  ...
                  if (4 === node$jscomp$0.length) {
                    ...
                    b: {
                      ...
                      try {
                        ...
                        props.status = 4, childNodes = getThrownInfo(task.componentStack), replay = logRecoverableError(request, error3, childNodes), props.errorDigest = replay, task.replay.pendingTasks--, request.clientRenderedBoundaries.push(props);
                      } finally {
      ...
      for (var replay = task.replay, replayNodes = replay.nodes, j = 0; j < replayNodes.length; j++) {
        ...
        if (node[1] === childIndex) {
          ...
          try {
            ...
            abortRemainingReplayNodes(request, boundary, childIndex, node, error3, children);
          }
          task.replay = replay;
  ...
  function abortRemainingReplayNodes(request$jscomp$0, boundary, nodes, slots, error3, errorDigest$jscomp$0) {
    for (var i = 0; i < nodes.length; i++) {
      var node = nodes[i];
      if (4 === node.length) abortRemainingReplayNodes(request$jscomp$0, boundary, node[2], node[3], error3, errorDigest$jscomp$0);
      else {
        node = node[5];
  ...
  function abortTask(task, request, error3) {
    ...
    if (null === boundary) {
      if (13 !== request.status && 14 !== request.status) {
        ...
        0 === boundary.pendingTasks && 0 < boundary.nodes.length && (segment = logRecoverableError(request, error3, errorInfo), abortRemainingReplayNodes(request, null, boundary.nodes, boundary.slots, error3, segment));
      ...
      if (4 !== boundary.status) {
        if (null !== trackedPostpones$64 && null !== segment) return logRecoverableError(request, error3, errorInfo), trackPostpone(request, trackedPostpones$64, task, segment), boundary.fallbackAbortableTasks.forEach(function(fallbackTask) {
...
var require_react_dom_server_legacy_browser_production = /* @__PURE__ */ __commonJSMin(((exports) => {
  ...
  function defaultErrorHandler(error3) {
    if ("object" === typeof error3 && null !== error3 && "string" === typeof error3.environmentName) {
      var JSCompiler_inline_result = error3.environmentName;
      error3 = [error3].slice(0);
      "string" === typeof error3[0] ? error3.splice(0, 1, "[%s] " + error3[0], " " + JSCompiler_inline_result + " ") : error3.splice(0, 0, "[%s]", " " + JSCompiler_inline_result + " ");
      error3.unshift(console);
      JSCompiler_inline_result = bind.apply(console.error, error3);
      JSCompiler_inline_result();
    } else console.error(error3);
  ...
  function renderElement(request, task, keyPath, type, props, ref2) {
    if ("function" === typeof type) if (type.prototype && type.prototype.isReactComponent) {
      ...
      if ("function" !== typeof type.getDerivedStateFromProps && "function" !== typeof newProps.getSnapshotBeforeUpdate && ("function" === typeof newProps.UNSAFE_componentWillMount || "function" === typeof newProps.componentWillMount)) if (type = newProps.state, "function" === typeof newProps.componentWillMount && newProps.componentWillMount(), "function" === typeof newProps.UNSAFE_componentWillMount && newProps.UNSAFE_componentWillMount(), type !== newProps.state && classComponentUpdater.enqueueReplaceState(newProps, newProps.state, null), null !== defaultProps.queue && 0 < defaultProps.queue.length) if (type = defaultProps.queue, ref2 = defaultProps.replace, defaultProps.queue = null, defaultProps.replace = false, ref2 && 1 === type.length) newProps.state = type[0];
        ...
        defaultProps = ref2 ? type[0] : newProps.state;
        initialState = true;
        for (ref2 = ref2 ? 1 : 0; ref2 < type.length; ref2++) propName$43 = type[ref2], propName$43 = "function" === typeof propName$43 ? propName$43.call(newProps, defaultProps, props, void 0) : propName$43, null != propName$43 && (initialState ? (initialState = false, defaultProps = assign({}, defaultProps, propName$43)) : assign(defaultProps, propName$43));
        newProps.state = defaultProps;
      }
      else defaultProps.queue = null;
      type = newProps.render();
  ...
  function abortTask(task, request, error3) {
    ...
    if (null === boundary) {
      ...
      if (4 !== boundary.status) {
        if (null !== trackedPostpones$63 && null !== segment) return logRecoverableError(request, error3, errorInfo), trackPostpone(request, trackedPostpones$63, task, segment), boundary.fallbackAbortableTasks.forEach(function(fallbackTask) {
          return abortTask(fallbackTask, request, error3);
        }), boundary.fallbackAbortableTasks.clear(), finishedTask(request, boundary, task.row, segment);
        boundary.status = 4;
        segment = logRecoverableError(request, error3, errorInfo);
...
var StaticHtml = /* @__PURE__ */ __name(({ value, name, hydrate = true }) => {
...
var require_parse = /* @__PURE__ */ __commonJSMin(((exports, module) => {
  ...
  var buildCharClassStar = /* @__PURE__ */ __name((chars) => {
    return `${chars.length === 1 ? utils.escapeRegex(chars[0]) : `[${chars.map((ch) => utils.escapeRegex(ch)).join("")}]`}*`;
  }, "buildCharClassStar");
  var getStarExtglobSequenceChars = /* @__PURE__ */ __name((pattern) => {
    let index = 0;
    const chars = [];
...
function toMatcher(pattern) {
  ...
  return { test: /* @__PURE__ */ __name((what) => fn(what), "test") };
}
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  if (children && _astro_react_opts_default.experimentalReactChildren) {
    ...
    newProps.children = (await import("./chunks/vnode-children_DmWmphrv.mjs").then((mod) => mod.default))(children);
...
function throwEnhancedErrorIfMdxComponent(error3, Component) {
  if (Component[/* @__PURE__ */ Symbol.for("mdx-component")]) {
    if (AstroUserError.is(error3)) return;
    error3.title = error3.name;
    error3.hint = `This issue often occurs when your MDX component encounters runtime errors.`;
    throw error3;
  }
}
...
}, { ssr: server_default$2 }), Object.assign({
  "name": "astro:jsx",
  "serverEntrypoint": "file:///Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/mdx/dist/server.js"
...
[
  ...
  },
  {
    ...
    "routeData": {
      ...
      "params": ["...path"],
      "component": "src/pages/admin/[...path].ts",
      "prerender": false,
      "fallbackRoutes": [],
      "distURL": [],
      "origin": "project",
  ...
  },
  {
    ...
    "routeData": {
      ...
      "params": ["...path"],
      "component": "src/pages/media/[...path].ts",
      "prerender": false,
      "fallbackRoutes": [],
      "distURL": [],
      "origin": "project",
  ...
  },
  {
    ...
    "routeData": {
      ...
      "params": ["...slug"],
      "component": "src/pages/posts/[...slug]/index.astro",
      "prerender": false,
      "fallbackRoutes": [],
      "distURL": [],
      "origin": "project",
  ...
  },
  {
    ...
    "routeData": {
      ...
      "params": ["...path"],
      "component": "src/pages/sys/[...path].ts",
      "prerender": false,
      "fallbackRoutes": [],
      "distURL": [],
      "origin": "project",
...
var _page0 = /* @__PURE__ */ __name(() => import("./chunks/image-transform-endpoint_qJZMuvpW.mjs"), "_page0");
var _page1 = /* @__PURE__ */ __name(() => import("./chunks/404_cO0NuuZT.mjs"), "_page1");
var _page2 = /* @__PURE__ */ __name(() => import("./chunks/about_BnOo82zb.mjs"), "_page2");
var _page3 = /* @__PURE__ */ __name(() => import("./chunks/_.._D6jvKIh4.mjs"), "_page3");
var _page4 = /* @__PURE__ */ __name(() => import("./chunks/_.._BQRbsnx8.mjs"), "_page4");
var _page5 = /* @__PURE__ */ __name(() => import("./chunks/index_C1KIBQsC.mjs"), "_page5");
var _page6 = /* @__PURE__ */ __name(() => import("./chunks/_.._Crb5os4u.mjs"), "_page6");
var _page7 = /* @__PURE__ */ __name(() => import("./chunks/index_Caa3N1g5.mjs"), "_page7");
var _page8 = /* @__PURE__ */ __name(() => import("./chunks/index_DhBs7wkR.mjs"), "_page8");
var _page9 = /* @__PURE__ */ __name(() => import("./chunks/robots_CnvK-3Vq.mjs"), "_page9");
var _page10 = /* @__PURE__ */ __name(() => import("./chunks/rss_DrByeg92.mjs"), "_page10");
var _page11 = /* @__PURE__ */ __name(() => import("./chunks/search_CTI8bRFY.mjs"), "_page11");
var _page12 = /* @__PURE__ */ __name(() => import("./chunks/_.._DO5mpjjm.mjs"), "_page12");
var _page13 = /* @__PURE__ */ __name(() => import("./chunks/index_BslS5M50.mjs"), "_page13");
var _page14 = /* @__PURE__ */ __name(() => import("./chunks/index_BUeNSOYK.mjs"), "_page14");
var _page15 = /* @__PURE__ */ __name(() => import("./chunks/index_C3gjTYYx.mjs"), "_page15");
var pageMap = /* @__PURE__ */ new Map([
  ["node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", _page0],
  ["src/pages/404.astro", _page1],
  ["src/pages/about.astro", _page2],
  ["src/pages/admin/[...path].ts", _page3],
  ["src/pages/api/[...path].ts", _page4],
  ["src/pages/archives/index.astro", _page5],
  ["src/pages/media/[...path].ts", _page6],
  ...
  ["src/pages/sys/[...path].ts", _page12],
  ["src/pages/tags/[tag]/index.astro", _page13],
  ["src/pages/tags/index.astro", _page14],
  ["src/pages/index.astro", _page15]
]);
var _manifest = deserializeManifest({ "rootDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/", "cacheDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/node_modules/.astro/", "outDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/dist/", "srcDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/src/", "publicDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/public/", "buildClientDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/dist/client/", "buildServerDir": "file:///Users/cakiphin/projects/cmsMu/astro-paper/dist/server/", "adapterName": "@astrojs/cloudflare", "assetsDir": "_astro", "routes": [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "type": "page", "component": "_server-islands.astro", "params": ["name"], "segments": [[{ "content": "_server-islands", "dynamic": false, "spread": false }], [{ "content": "name", "dynamic": true, "spread": false }]], "pattern": "^\\/_server-islands\\/([^/]+?)\\/?$", "prerender": false, "isIndex": false, "fallbackRoutes": [], "route": "/_server-islands/[name]", "origin": "internal", "distURL": [], "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/_image", "component": "node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", "params": [], "pathname": "/_image", "pattern": "^\\/_image\\/?$", "segments": [[{ "content": "_image", "dynamic": false, "spread": false }]], "type": "endpoint", "prerender": false, "fallbackRoutes": [], "distURL": [], "isIndex": false, "origin": "internal", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }], "routeData": { "route": "/404", "isIndex": false, "type": "page", "pattern": "^\\/404\\/?$", "segments": [[{ "content": "404", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/404.astro", "pathname": "/404", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }], "routeData": { "route": "/about", "isIndex": false, "type": "page", "pattern": "^\\/about\\/?$", "segments": [[{ "content": "about", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/about.astro", "pathname": "/about", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/admin/[...path]", "isIndex": false, "type": "endpoint", "pattern": "^\\/admin(?:\\/(.*?))?\\/?$", "segments": [[{ "content": "admin", "dynamic": false, "spread": false }], [{ "content": "...path", "dynamic": true, "spread": true }]], "params": ["...path"], "component": "src/pages/admin/[...path].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/[...path]", "isIndex": false, "type": "endpoint", "pattern": "^\\/api(?:\\/(.*?))?\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "...path", "dynamic": true, "spread": true }]], "params": ["...path"], "component": "src/pages/api/[...path].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/archives", "isIndex": true, "type": "page", "pattern": "^\\/archives\\/?$", "segments": [[{ "content": "archives", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/archives/index.astro", "pathname": "/archives", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/media/[...path]", "isIndex": false, "type": "endpoint", "pattern": "^\\/media(?:\\/(.*?))?\\/?$", "segments": [[{ "content": "media", "dynamic": false, "spread": false }], [{ "content": "...path", "dynamic": true, "spread": true }]], "params": ["...path"], "component": "src/pages/media/[...path].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/posts", "isIndex": true, "type": "page", "pattern": "^\\/posts\\/?$", "segments": [[{ "content": "posts", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/posts/index.astro", "pathname": "/posts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/posts/[...slug]", "isIndex": true, "type": "page", "pattern": "^\\/posts(?:\\/(.*?))?\\/?$", "segments": [[{ "content": "posts", "dynamic": false, "spread": false }], [{ "content": "...slug", "dynamic": true, "spread": true }]], "params": ["...slug"], "component": "src/pages/posts/[...slug]/index.astro", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/robots.txt", "isIndex": false, "type": "endpoint", "pattern": "^\\/robots\\.txt$", "segments": [[{ "content": "robots.txt", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/robots.txt.ts", "pathname": "/robots.txt", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/rss.xml", "isIndex": false, "type": "endpoint", "pattern": "^\\/rss\\.xml$", "segments": [[{ "content": "rss.xml", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/rss.xml.ts", "pathname": "/rss.xml", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }, { "type": "external", "src": "_astro/search.BpBHEDkL.css" }, { "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }], "routeData": { "route": "/search", "isIndex": false, "type": "page", "pattern": "^\\/search\\/?$", "segments": [[{ "content": "search", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/search.astro", "pathname": "/search", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/sys/[...path]", "isIndex": false, "type": "endpoint", "pattern": "^\\/sys(?:\\/(.*?))?\\/?$", "segments": [[{ "content": "sys", "dynamic": false, "spread": false }], [{ "content": "...path", "dynamic": true, "spread": true }]], "params": ["...path"], "component": "src/pages/sys/[...path].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/tags/[tag]", "isIndex": true, "type": "page", "pattern": "^\\/tags\\/([^/]+?)\\/?$", "segments": [[{ "content": "tags", "dynamic": false, "spread": false }], [{ "content": "tag", "dynamic": true, "spread": false }]], "params": ["tag"], "component": "src/pages/tags/[tag]/index.astro", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/tags", "isIndex": true, "type": "page", "pattern": "^\\/tags\\/?$", "segments": [[{ "content": "tags", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/tags/index.astro", "pathname": "/tags", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Footer.Bub8Rb0M.css" }, { "type": "inline", "content": "@keyframes astroFadeInOut{0%{opacity:1}to{opacity:0}}@keyframes astroFadeIn{0%{opacity:0;mix-blend-mode:plus-lighter}to{opacity:1;mix-blend-mode:plus-lighter}}@keyframes astroFadeOut{0%{opacity:1;mix-blend-mode:plus-lighter}to{opacity:0;mix-blend-mode:plus-lighter}}@keyframes astroSlideFromRight{0%{transform:translate(100%)}}@keyframes astroSlideFromLeft{0%{transform:translate(-100%)}}@keyframes astroSlideToRight{to{transform:translate(100%)}}@keyframes astroSlideToLeft{to{transform:translate(-100%)}}@media (prefers-reduced-motion){::view-transition-group(*){animation:none!important}::view-transition-old(*){animation:none!important}::view-transition-new(*){animation:none!important}[data-astro-transition-scope]{animation:none!important}}\n" }], "routeData": { "route": "/", "isIndex": true, "type": "page", "pattern": "^\\/$", "segments": [], "params": [], "component": "src/pages/index.astro", "pathname": "/", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }], "serverLike": true, "middlewareMode": "classic", "site": "https://astro-paper.pages.dev/", "base": "/", "trailingSlash": "ignore", "compressHTML": "jsx", "componentMetadata": [["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/posts/[...slug]/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/404.astro", { "propagation": "none", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/about.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/archives/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/posts/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/search.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/tags/[tag]/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/tags/index.astro", { "propagation": "in-tree", "containsHead": true }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Card.astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/archives/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:pages", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:manifest", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/astro/dist/core/app/entrypoints/virtual/prod.js", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:app", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/astro/dist/core/app/entrypoints/virtual/index.js", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/cloudflare/dist/utils/handler.js", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/cloudflare/dist/entrypoints/server.js", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:cloudflare/worker-entry", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/posts/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/tags/[tag]/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Tag.astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/posts/[...slug]/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/tags/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/search@_@astro", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/adding-new-post.mdx?astroPropagatedAssets", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/.astro/content-modules.mjs", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/astro/dist/content/runtime.js", { "propagation": "in-tree", "containsHead": false }], ["\0astro:content", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:page:src/pages/about@_@astro", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/customizing-astropaper-theme-color-schemes.mdx?astroPropagatedAssets", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/how-to-configure-astropaper-theme.mdx?astroPropagatedAssets", { "propagation": "in-tree", "containsHead": false }], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/_color-schemes/predefined-color-schemes.mdx?astroPropagatedAssets", { "propagation": "in-tree", "containsHead": false }]], "renderers": [], "clientDirectives": [["idle", '(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value=="object"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};"requestIdleCallback"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event("astro:idle"));})();'], ["load", '(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event("astro:load"));})();'], ["media", '(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener("change",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event("astro:media"));})();'], ["only", '(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event("astro:only"));})();'], ["visible", '(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value=="object"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event("astro:visible"));})();']], "entryModules": { "virtual:cloudflare/worker-entry": "entry.mjs", "\0virtual:astro:middleware": "virtual_astro_middleware.mjs", "\0virtual:astro:server-island-manifest": "chunks/_virtual_astro_server-island-manifest_q0HM18kM.mjs", "\0virtual:astro:session-driver": "chunks/_virtual_astro_session-driver_TyipGO2P.mjs", "\0virtual:astro:actions/noop-entrypoint": "chunks/noop-entrypoint_BYLrzUxc.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/cloudflare/dist/utils/static-image-collection.js": "chunks/static-image-collection_Dt0LCp6-.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/react/dist/vnode-children.js": "chunks/vnode-children_DmWmphrv.mjs", "\0virtual:astro:page:src/pages/404@_@astro": "chunks/404_cO0NuuZT.mjs", "\0virtual:astro:page:src/pages/api/[...path]@_@ts": "chunks/_.._BQRbsnx8.mjs", "\0virtual:astro:page:src/pages/media/[...path]@_@ts": "chunks/_.._Crb5os4u.mjs", "\0virtual:astro:page:src/pages/admin/[...path]@_@ts": "chunks/_.._D6jvKIh4.mjs", "\0virtual:astro:page:src/pages/sys/[...path]@_@ts": "chunks/_.._DO5mpjjm.mjs", "\0astro:data-layer-content": "chunks/_astro_data-layer-content_BGMm6prl.mjs", "\0virtual:astro:get-image": "chunks/_virtual_astro_get-image_BKvzkKQp.mjs", "\0virtual:astro:page:src/pages/about@_@astro": "chunks/about_BnOo82zb.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/adding-new-post.mdx": "chunks/adding-new-post_B-J3Hrjw.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/adding-new-post.mdx?astroPropagatedAssets": "chunks/adding-new-post_BqqW6kCB.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/.astro/content-assets.mjs": "chunks/content-assets_BabcVmeS.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/.astro/content-modules.mjs": "chunks/content-modules_DnTXu6y1.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/customizing-astropaper-theme-color-schemes.mdx": "chunks/customizing-astropaper-theme-color-schemes_MZ9aXaHf.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/customizing-astropaper-theme-color-schemes.mdx?astroPropagatedAssets": "chunks/customizing-astropaper-theme-color-schemes_cNx2qMcI.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/public/default-og.jpg": "chunks/default-og_RlXGE9Nq.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/facebook.svg": "chunks/facebook_DCC3Es2h.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/public/favicon.svg": "chunks/favicon_Bbd8Fcmw.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/github.svg": "chunks/github_CJBsN-bv.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/how-to-configure-astropaper-theme.mdx?astroPropagatedAssets": "chunks/how-to-configure-astropaper-theme_C_Sty_2C.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/how-to-configure-astropaper-theme.mdx": "chunks/how-to-configure-astropaper-theme__GHdkGzW.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js": "chunks/image-service-workerd_Y4jDZwMG.mjs", "\0virtual:astro:page:node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint@_@js": "chunks/image-transform-endpoint_qJZMuvpW.mjs", "\0virtual:astro:page:src/pages/tags/index@_@astro": "chunks/index_BUeNSOYK.mjs", "\0virtual:astro:page:src/pages/tags/[tag]/index@_@astro": "chunks/index_BslS5M50.mjs", "\0virtual:astro:page:src/pages/archives/index@_@astro": "chunks/index_C1KIBQsC.mjs", "\0virtual:astro:page:src/pages/index@_@astro": "chunks/index_C3gjTYYx.mjs", "\0virtual:astro:page:src/pages/posts/index@_@astro": "chunks/index_Caa3N1g5.mjs", "\0virtual:astro:page:src/pages/posts/[...slug]/index@_@astro": "chunks/index_DhBs7wkR.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/linkedin.svg": "chunks/linkedin_MyysDTR9.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/mail.svg": "chunks/mail_BZBACUGf.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/pinterest.svg": "chunks/pinterest_Cxkjpn1u.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/_color-schemes/predefined-color-schemes.mdx": "chunks/predefined-color-schemes_ByPjBKah.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/content/posts/_color-schemes/predefined-color-schemes.mdx?astroPropagatedAssets": "chunks/predefined-color-schemes_DyMvLPy-.mjs", "\0virtual:astro:page:src/pages/robots.txt@_@ts": "chunks/robots_CnvK-3Vq.mjs", "\0virtual:astro:page:src/pages/rss.xml@_@ts": "chunks/rss_DrByeg92.mjs", "\0virtual:astro:page:src/pages/search@_@astro": "chunks/search_CTI8bRFY.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/telegram.svg": "chunks/telegram_BNxqGxf8.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/whatsapp.svg": "chunks/whatsapp_BXX47W6j.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/assets/icons/socials/x.svg": "chunks/x_5NBMLVCo.mjs", "/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/posts/[...slug]/_components/BackButton.astro?astro&type=script&index=0&lang.ts": "_astro/BackButton.astro_astro_type_script_index_0_lang.gktCeeAC.js", "/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts": "_astro/ClientRouter.astro_astro_type_script_index_0_lang.Dr1mtRvi.js", "/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Header.astro?astro&type=script&index=0&lang.ts": "_astro/Header.astro_astro_type_script_index_0_lang.DF3k8XzY.js", "/Users/cakiphin/projects/cmsMu/astro-paper/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts": "_astro/Layout.astro_astro_type_script_index_0_lang.D2EMWquF.js", "/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Main.astro?astro&type=script&index=0&lang.ts": "_astro/Main.astro_astro_type_script_index_0_lang.-BhIP1bB.js", "@astrojs/react/client.js": "_astro/client.CEnc6HRx.js", "/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/index.astro?astro&type=script&index=0&lang.ts": "_astro/index.astro_astro_type_script_index_0_lang.vBIKUmDR.js", "/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/search.astro?astro&type=script&index=0&lang.ts": "_astro/search.astro_astro_type_script_index_0_lang.BPkpJLDs.js", "/Users/cakiphin/projects/cmsMu/astro-paper/node_modules/@pagefind/default-ui/npm_dist/mjs/ui-core.mjs": "_astro/ui-core.D_fvhl2h.js", "astro:scripts/before-hydration.js": "" }, "inlinedScripts": [["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/posts/[...slug]/_components/BackButton.astro?astro&type=script&index=0&lang.ts", "globalThis.process??={},globalThis.process.env??={};function e(){let e=document.querySelector(`#back-button`),t=sessionStorage.getItem(`backUrl`);t&&e&&(e.href=t)}document.addEventListener(`astro:page-load`,e),e();"], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Header.astro?astro&type=script&index=0&lang.ts", "globalThis.process??={},globalThis.process.env??={};function e(){let e=document.querySelector(`#menu-btn`),t=document.querySelector(`#menu-items`),n=document.querySelector(`#menu-icon`),r=document.querySelector(`#close-icon`);if(!e||!t||!n||!r)return;let i=e.dataset.labelOpen??`Open menu`,a=e.dataset.labelClose??`Close menu`;e.addEventListener(`click`,()=>{let o=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,o?`false`:`true`),e.setAttribute(`aria-label`,o?i:a),t.classList.toggle(`hidden`),t.classList.toggle(`grid`),n.classList.toggle(`hidden`),r.classList.toggle(`hidden`)})}e(),document.addEventListener(`astro:after-swap`,e);"], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts", "globalThis.process??={},globalThis.process.env??={};var e=`theme`,t=`light`,n=`dark`;function r(){return localStorage.getItem(e)||(window.matchMedia(`(prefers-color-scheme: dark)`).matches?n:t)}var i=window.__theme?.value??r();function a(){localStorage.setItem(e,i),o()}function o(){let e=document.firstElementChild;e?.setAttribute(`data-theme`,i),e?.classList.toggle(`dark`,i===n),document.querySelector(`#theme-btn`)?.setAttribute(`aria-label`,i);let t=window.getComputedStyle(document.body).backgroundColor;document.querySelector(`meta[name='theme-color']`)?.setAttribute(`content`,t)}function s(){o(),document.querySelector(`#theme-btn`)?.addEventListener(`click`,()=>{i=i===t?n:t,a()})}s(),document.addEventListener(`astro:after-swap`,s),document.addEventListener(`astro:before-swap`,e=>{let t=document.querySelector(`meta[name='theme-color']`)?.getAttribute(`content`);t&&e.newDocument.querySelector(`meta[name='theme-color']`)?.setAttribute(`content`,t)}),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,({matches:e})=>{i=e?n:t,a()});"], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/components/Main.astro?astro&type=script&index=0&lang.ts", "globalThis.process??={},globalThis.process.env??={},document.addEventListener(`astro:page-load`,()=>{let e=document.querySelector(`#main-content`)?.dataset?.backurl;e&&sessionStorage.setItem(`backUrl`,e)});"], ["/Users/cakiphin/projects/cmsMu/astro-paper/src/pages/index.astro?astro&type=script&index=0&lang.ts", "globalThis.process??={},globalThis.process.env??={},document.addEventListener(`astro:page-load`,()=>{let e=document.querySelector(`#main-content`)?.dataset,t=`/`.replace(/\\/?$/,`/`);e?.layout&&sessionStorage.setItem(`backUrl`,e.homePath??t)});"]], "assets": ["/default-og.jpg", "/favicon.svg", "/_astro/ClientRouter.astro_astro_type_script_index_0_lang.Dr1mtRvi.js", "/_astro/client.CEnc6HRx.js", "/_astro/search.astro_astro_type_script_index_0_lang.BPkpJLDs.js", "/_astro/ui-core.D_fvhl2h.js", "/pagefind/pagefind-component-ui.css", "/pagefind/pagefind-component-ui.js", "/pagefind/pagefind-entry.json", "/pagefind/pagefind-highlight.js", "/pagefind/pagefind-modular-ui.css", "/pagefind/pagefind-modular-ui.js", "/pagefind/pagefind-ui.css", "/pagefind/pagefind-ui.js", "/pagefind/pagefind-worker.js", "/pagefind/pagefind.en_319548c67b.pf_meta", "/pagefind/pagefind.en_e2145bf56a.pf_meta", "/pagefind/pagefind.js", "/pagefind/wasm.en.pagefind", "/pagefind/wasm.unknown.pagefind", "/_astro/fonts/02154cca78ac33f2.woff", "/_astro/fonts/0863f4f6964aa89c.ttf", "/_astro/fonts/14314705006234cb.woff", "/_astro/fonts/3a32a7a7a67f4f58.woff", "/_astro/fonts/478e42e4694872ef.ttf", "/_astro/fonts/792eded6cb3f0350.ttf", "/_astro/fonts/7a5ee0cfcde31b81.ttf", "/_astro/fonts/87ca066ba5b2c7cf.woff", "/_astro/fonts/87d8fc1072d4917b.ttf", "/_astro/fonts/90f9809471092714.ttf", "/_astro/fonts/a5c5808c25effec9.woff", "/_astro/fonts/a9a0e80c053be3d5.woff", "/_astro/fonts/a9df48ecd03749e4.ttf", "/_astro/fonts/c26ad40d3b1d9169.woff", "/_astro/fonts/c33265ba093eb291.woff", "/_astro/fonts/da468df88542c99b.woff", "/_astro/fonts/dbc9996f99c63e07.ttf", "/_astro/fonts/ec883ed4db81a7d9.ttf", "/_astro/fonts/f4e25dfe9d6152ec.ttf", "/_astro/fonts/f914de358bc554f6.woff", "/pagefind/index/en_1caa472.pf_index", "/pagefind/index/en_5136279.pf_index", "/pagefind/index/en_ea963a2.pf_index", "/pagefind/index/en_f0c7771.pf_index", "/pagefind/fragment/en_12a02f2.pf_fragment", "/pagefind/fragment/en_12d17f2.pf_fragment", "/pagefind/fragment/en_1625881.pf_fragment", "/pagefind/fragment/en_199a6cb.pf_fragment", "/pagefind/fragment/en_1e11f2a.pf_fragment", "/pagefind/fragment/en_2ac6b47.pf_fragment", "/pagefind/fragment/en_2c6a3e4.pf_fragment", "/pagefind/fragment/en_3f46ae7.pf_fragment", "/pagefind/fragment/en_5befa51.pf_fragment", "/pagefind/fragment/en_61bda33.pf_fragment", "/pagefind/fragment/en_63b3c46.pf_fragment", "/pagefind/fragment/en_6a20ac7.pf_fragment", "/pagefind/fragment/en_6c21e4b.pf_fragment", "/pagefind/fragment/en_76227d9.pf_fragment", "/pagefind/fragment/en_79b2d1d.pf_fragment", "/pagefind/fragment/en_7ee4a64.pf_fragment", "/pagefind/fragment/en_8417441.pf_fragment", "/pagefind/fragment/en_8bc9147.pf_fragment", "/pagefind/fragment/en_8cb75ba.pf_fragment", "/pagefind/fragment/en_9481feb.pf_fragment", "/pagefind/fragment/en_9f7d78f.pf_fragment", "/pagefind/fragment/en_ac295c4.pf_fragment", "/pagefind/fragment/en_b3f36f5.pf_fragment", "/pagefind/fragment/en_bc4a1ef.pf_fragment", "/pagefind/fragment/en_c1b01d9.pf_fragment", "/pagefind/fragment/en_cec035a.pf_fragment", "/pagefind/fragment/en_d388ee3.pf_fragment", "/pagefind/fragment/en_d878f05.pf_fragment", "/pagefind/fragment/en_da64f7a.pf_fragment", "/pagefind/fragment/en_e418465.pf_fragment", "/pagefind/fragment/en_e47d66b.pf_fragment", "/pagefind/fragment/en_e84ac8d.pf_fragment", "/pagefind/fragment/en_fb53b91.pf_fragment", "/pagefind/fragment/en_fc5ba0e.pf_fragment", "/_astro/IconRss.BYWRoVjV.svg", "/_astro/IconArrowRight.D72qTBYn.svg", "/_astro/IconArrowNarrowUp.u0CdFf4k.svg", "/_astro/IconEdit.BuUItOMC.svg", "/_astro/IconCalendar.C0xY3fv4.svg", "/_astro/IconArrowLeft.7rKuNJsZ.svg", "/_astro/github.D4TpU-sh.svg", "/_astro/linkedin.CgFOWy_H.svg", "/_astro/facebook.DViGtK9D.svg", "/_astro/pinterest.Fl4F684Z.svg", "/_astro/mail.BsR8RxJL.svg", "/_astro/x.ATC87rTm.svg", "/_astro/telegram.Btn5McfO.svg", "/_astro/whatsapp.B1vN587S.svg", "/_astro/IconChevronLeft.DBA9GJaK.svg", "/_astro/IconHash.CPmqEwD_.svg", "/_astro/IconMenuDeep.CczWFiGg.svg", "/_astro/IconUnderline.DIUG30rA.svg", "/_astro/IconX.DK0Dc7zq.svg", "/_astro/IconSunHigh.EHu4P2Sl.svg", "/_astro/IconSearch.w3diR66o.svg", "/_astro/IconMoon.CRxdR147.svg", "/_astro/IconArchive.Woxh8eou.svg", "/_astro/default-og.jWlOTf-L.jpg", "/_astro/favicon.vp_fBu0c.svg", "/_astro/AstroPaper-v5.BKHVI1Ox.png", "/_astro/forrest-gump-quote.A3mC0z9n.png", "/_astro/AstroPaper-v3.uaW8qzSG.png", "/_astro/AstroPaper-v4.TylavUIc.png", "/_astro/AstroPaper-v6.CUw5ELn5.png", "/_astro/ember.DOqR1B5L.png", "/_astro/espresso.IOpR_PCA.png", "/_astro/paper-light.DG6KKT16.png", "/_astro/pyit-tine-htaung.Bx-NgjUd.png", "/_astro/jadeite.akvlVbRs.png", "/_astro/nila.DfOkdVEp.png", "/_astro/kha-yan.C_7i0MqE.png", "/_astro/Footer.Bub8Rb0M.css", "/_astro/search.BpBHEDkL.css"], "i18n": { "fallbackType": "redirect", "strategy": "pathname-prefix-other-locales", "locales": ["en"], "defaultLocale": "en", "domainLookupTable": {} }, "buildFormat": "directory", "checkOrigin": true, "actionBodySizeLimit": 1048576, "serverIslandBodySizeLimit": 1048576, "allowedDomains": [], "key": "zqb/1TiI/RnrTCU8Rwt4YDJqez80OQWyWhsS5KgLonM=", "sessionConfig": { "driver": "unstorage/drivers/cloudflare-kv-binding", "options": { "binding": "SESSION" } }, "image": {}, "devToolbar": { "enabled": false, "debugInfoOutput": "" }, "logLevel": "info", "shouldInjectCspMetaTags": false });
var manifestRoutes = _manifest.routes;
var manifest = Object.assign(_manifest, {
  renderers,
  actions: /* @__PURE__ */ __name(() => import("./chunks/noop-entrypoint_BYLrzUxc.mjs"), "actions"),
  middleware: /* @__PURE__ */ __name(() => import("./virtual_astro_middleware.mjs"), "middleware"),
  sessionDriver: /* @__PURE__ */ __name(() => import("./chunks/_virtual_astro_session-driver_TyipGO2P.mjs"), "sessionDriver"),
  serverIslandMappings: /* @__PURE__ */ __name(() => import("./chunks/_virtual_astro_server-island-manifest_q0HM18kM.mjs"), "serverIslandMappings"),
  routes: manifestRoutes,
  pageMap
});
var createApp$1 = /* @__PURE__ */ __name(({ streaming } = {}) => {
  const app2 = new App(manifest, streaming);
  app2.setFetchHandler(_virtual_astro_fetchable_default);
  return app2;
}, "createApp$1");
...
__name(isValidIpAddress, "isValidIpAddress");
...
__name(getValidatedIpFromHeader, "getValidatedIpFromHeader");
function matchStaticAsset(manifest2, requestUrl, env2) {
  const { pathname } = new URL(requestUrl);
  if (manifest2.assets.has(pathname)) return env2.ASSETS.fetch(requestUrl.replace(/\.html$/, ""));
}
__name(matchStaticAsset, "matchStaticAsset");
async function fallbackToAssets(requestUrl, env2) {
  const asset = await env2.ASSETS.fetch(requestUrl.replace(/index.html$/, "").replace(/\.html$/, ""));
  if (asset.status !== 404) return asset;
}
__name(fallbackToAssets, "fallbackToAssets");
function createErrorPageFetch(env2) {
  return async (url) => {
    return env2.ASSETS.fetch(url.replace(/\.html$/, ""));
  };
}
__name(createErrorPageFetch, "createErrorPageFetch");
...
__name(createLocals, "createLocals");
function getClientAddress(request) {
  return getValidatedIpFromHeader(request.headers.get("cf-connecting-ip"));
}
__name(getClientAddress, "getClientAddress");
function injectSessionBinding(manifest2, env2) {
  if (env2["SESSION"]) {
    const sessionConfigOptions = manifest2.sessionConfig?.options ?? {};
    Object.assign(sessionConfigOptions, { binding: env2[sessionKVBindingName] });
  }
}
__name(injectSessionBinding, "injectSessionBinding");
var app = createApp();
async function handle(request, env2, context2) {
  ...
  const locals = createLocals(context2);
...
* LICENSE file in the root directory of this source tree.
*/
//# sourceMappingURL=bundledWorker-0.7163137592139828.mjs.map
